...
# Testing standards for KERI implementation (Pytest, Asyncio, Distributed Systems)
---
## Use when
...
- **Exception for Challenge**: If using Falcon's synchronous `TestClient` for the test fixture, standard synchronous pytest functions are acceptable. Async testing is only required if using Falcon ASGI.
- **KERI Primitives**:
