---
applyTo: "**/*.py,**/*.tf,**/*.hcl"
# KERI Security Standards: Cryptography, Key Management, and End-Verifiability
---
## Use when
...
- **Gateway-First Authentication**:
    - **Exception for Challenge**: This challenge requires **application-level verification** of signature headers. The application (Falcon) MUST verify the signature header on every request. Do not offload this to a gateway for this task.
