...
applyTo: "**/*"
---
# 🛑 Avoid Over-Engineering: Implementation Guide

> **"The goal is business value, not technical perfection."** — Greg Young
...
- **❌ Anti-Pattern:** Building complex automated recovery for rare data corruption or ambiguous inputs.
- **✅ Pattern:** Return a clear error or ask the user: *"I found an anomaly. How should I proceed?"*
...
| **Transport**| HTTP/TCP | Use **Falcon** (as per Rubric) for this challenge. |
...
| **Persistence** | **Memory/LMDB** | Data Layer | **In-Memory** dicts allowed for test fixtures (Rubric). LMDB for production. |
